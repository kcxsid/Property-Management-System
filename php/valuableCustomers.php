...
$db2 = "properties";
$conn2 = mysqli_connect($server1, $user1, $password1, $db2);



$db3 = "reser";
$conn3 = mysqli_connect($server1, $user1, $password1, $db3);
...
<body>
	...
	<header>
		...
		<div class = "container">
			...
			<div class = "col-lg-12">
				<br><br>
				<h1 class = "text-center"><strong>Platinum Members<br></strong></h1>
				...
				<?php 
					...
					$db2 = "properties";
					$conn2 = mysqli_connect($server, $user, $password, $db2);



					$db3 = "reser";
					$conn3 = mysqli_connect($server, $user, $password, $db3);



					$conn = mysqli_connect($server, $user, $password, $db);
					$q = "Select * From registration.registerinfo c Where not exists (Select r.ReservationID r From reser.reservation r Where not exists (Select p.propertyID From properties.propertyinfo p Where c.id=r.customerID and p.propertyID=r.PropertyID))";
					$query = mysqli_query($conn, $q);
