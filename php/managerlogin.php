...
if($conn){
  ...
  ?>
  <script>
      alert("No Connection to Manager db!");
  </script>
  <?php
...
if(isset($_POST['submit'])){
  ...
  $email_search = "select * from managerinfo where email = '$email' ";
  ...
  <script>
      ...
      location.replace("manager_loggedin.php");
  </script>
  <?php
...
?>
  ...
  <a class="navbar-brand" href="index.php">Manager Login</a>
  ...
  <div class = "main_div">
    <div class = "box">
      ...
      <form action = "<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method = "post">
        ...
        <div class="signup-link">New User?<a href="register_alt.php"> Register here</a> </div>
