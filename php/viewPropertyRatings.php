...
<body>
	...
	<header>
		...
		<div class = "container">
			...
			<div class = "col-lg-12">
				<br><br>
				<h1 class = "text-center"><strong>Average Rating for Properties</strong></h1>
				...
				<?php 
					...
					$conn = mysqli_connect($server, $user, $password, $db);
					$q = "SELECT AVG(value), ratingsinfo.propertyID from ratingsinfo GROUP BY ratingsinfo.propertyID"; 
